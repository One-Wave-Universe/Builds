...
**The cell is the complete differential-leaning system.** It is not one transistor pair, one toroid, one flower half, or one bus segment.

**1 volt.** Virtual-ground middle **0.50.** Wobble **0.45–0.55.**

Letters **are the six edges:** A+ B+ C+ A− B− C−. Shared sides form opposed differential surfaces. Opposed edges form three mirrored axes.

Three leans. Ternary is **DOWN / HOLD / UP** around **− / (0) / +**. **All analog. No global clock.**

## What counts as one cell

One CELL_V1 includes, as one coupled physical state machine:

- the three mirrored A/B/C differential axes,
